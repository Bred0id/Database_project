...
CREATE TABLE music_studio.users (
    ...
    CONSTRAINT users_full_name_check
        CHECK (full_name ~ '^[А-ЯЁA-Z][а-яёa-z-]+(\s[А-ЯЁA-Z][а-яёa-z-]+){1,2}$'),
    CONSTRAINT users_email_check
        CHECK (email ~ '^[A-Za-z0-9._%%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'),
    CONSTRAINT users_phone_number_check
        CHECK (phone_number ~ '^(\+7|8)\d{10}$'),
...
CREATE TABLE music_studio.studios (
    ...
    CONSTRAINT studios_studio_name_check
        CHECK (studio_name ~ '^[А-ЯЁA-Z0-9][А-ЯЁA-Za-zа-яёa-z0-9\s"«»()\-.,]{1,99}$'),
...
CREATE TABLE music_studio.equipment (
    ...
    CONSTRAINT equipment_studio_foreign_key
        FOREIGN KEY (studio_id)
        REFERENCES music_studio.studios (studio_id),
    CONSTRAINT equipment_equipment_name_check
        CHECK (equipment_name ~ '^[А-ЯЁA-Z0-9][А-ЯЁA-Za-zа-яёa-z0-9\s"«»()\-.,]{1,99}$'),
    CONSTRAINT equipment_equipment_type_check
        CHECK (equipment_type ~ '^[А-ЯЁA-Z][А-ЯЁA-Za-zа-яёa-z\s\-]{1,49}$'),
...
CREATE TABLE music_studio.bookings (
    ...
    CONSTRAINT bookings_user_foreign_key
        FOREIGN KEY (user_id)
        REFERENCES music_studio.users (user_id),
    CONSTRAINT bookings_studio_foreign_key
        FOREIGN KEY (studio_id)
        REFERENCES music_studio.studios (studio_id),
    CONSTRAINT bookings_end_time_check
        CHECK (end_time > start_time),
    CONSTRAINT bookings_purpose_check
        CHECK (purpose ~ '^[А-ЯЁA-Z0-9][А-ЯЁA-Za-zа-яёa-z0-9\s"«»()\-.,]{1,99}$'),
...
CREATE TABLE music_studio.payments (
    ...
    CONSTRAINT payments_booking_foreign_key
...
CREATE TABLE music_studio.booking_equipment (
    ...
    CONSTRAINT booking_equipment_booking_foreign_key
        FOREIGN KEY (booking_id)
        REFERENCES music_studio.bookings (booking_id),
    CONSTRAINT booking_equipment_equipment_foreign_key
...
CREATE TABLE music_studio.equipment_maintenance (
    ...
    CONSTRAINT equipment_maintenance_user_foreign_key
        FOREIGN KEY (responsible_user_id)
        REFERENCES music_studio.users (user_id),
    CONSTRAINT equipment_maintenance_equipment_foreign_key
        FOREIGN KEY (equipment_id)
        REFERENCES music_studio.equipment (equipment_id),
...
CREATE TABLE music_studio.reviews (
    ...
    CONSTRAINT reviews_studio_foreign_key
        FOREIGN KEY (studio_id)
        REFERENCES music_studio.studios (studio_id),
    CONSTRAINT reviews_user_foreign_key
        FOREIGN KEY (user_id)
        REFERENCES music_studio.users (user_id),
...
CREATE TABLE music_studio.review_equipment (
    ...
    CONSTRAINT review_equipment_equipment_foreign_key
        FOREIGN KEY (equipment_id)
        REFERENCES music_studio.equipment (equipment_id),
    CONSTRAINT review_equipment_review_foreign_key
