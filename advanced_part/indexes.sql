-- Используется индекс типа B-tree (по умолчанию в PostgreSQL),
-- так как в проекте активно применяются операции сравнения (<, >, BETWEEN)
-- по времени, а также сортировка (ORDER BY).
